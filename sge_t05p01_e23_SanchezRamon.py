...
def contar_letras_y_palabras(cadena: str) -> tuple:
    ...
    cadena_sin_simbolos = re.sub(REGEX_SYMBOL_GROUP, SYMBOL_GROUP_REPLACER, cadena.casefold()).strip()
    ...
    dicc_let["no-letra"] = len(re.findall(REGEX_SYMBOLS, cadena.casefold()))
