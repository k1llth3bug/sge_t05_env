...
class Bicicleta:
    def __init__(self, fecha_compra: date, marca: str, modelo: str, tipo: str, color: str, tamano_cuadro: float, tamano_ruedas: float, precio: float, lista_reparaciones: List[Reparacion] = None) -> None:
    ...
    @classmethod
    def from_dict(cls, datos_bici: dict):
        return cls(date.fromisoformat(datos_bici["fecha_compra"]), datos_bici["marca"], datos_bici["modelo"], datos_bici["tipo"], datos_bici["color"],
