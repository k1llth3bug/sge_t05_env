...
class Evento:
    def __init__(self, fecha: datetime, fecha_inscripcion: datetime, localidad: str, provincia: str, organizador: str, km_totales: float, precio: float) -> None:
    ...
    def es_valido(self, ev) -> bool:
        return not(self.__fecha == ev.get_fecha()) and not(self.__organizador == ev.get_organizador())
